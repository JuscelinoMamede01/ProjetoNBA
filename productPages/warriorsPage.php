    ...
    <main id="main">
      <section class="productImg">
        <ul class="prodImgList">
          <li>
            <img src="../img/warriors (1).png" alt="bostonImg1" onclick="changeImg('../img/warriors (1).png');"/>
          </li>
          <li>
            <img src="../img/warriors (2).png" alt="bostonImg1" onclick="changeImg('../img/warriors (2).png');"/>
          </li>
          <li>
            <img src="../img/warriors 3.png" alt="bostonImg1" onclick="changeImg('../img/warriors 3.png');" />
          </li>
          <li>
            <img src="../img/TAMimg.png" alt="bostonImg1" onclick="changeImg('../img/TAMimg.png');"/>
          </li>
        </ul>
        <img src="../img/warriors (1).png" alt="mainImg" id="mainImg" />
      </section>
      ...
      <form
        ...
        >
        <input type="hidden" name="productname" value="Camiseta NBA Golden State Warriors">
        <input type="hidden" name="codProd" id="codProdValue">
        <h2>Camiseta NBA Golden State Warriors</h2>
        <p id="codProd">Cod: LA007</p>
          <p>Escolha a <span>COR</span> :</p>
          <input type="color" id="color" name="Azul" value="#001D6E" disabled/>
