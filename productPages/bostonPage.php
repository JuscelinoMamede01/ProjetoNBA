    ...
    <main id="main">
      <section class="productImg">
        <ul class="prodImgList">
          <li>
            <img src="../img/boston (1).png" alt="bostonImg1" onclick="changeImg('../img/boston (1).png');"/>
          </li>
          <li>
            <img src="../img/boston (2).png" alt="bostonImg1" onclick="changeImg('../img/boston (2).png');"/>
          </li>
          <li>
            <img src="../img/boston (3).png" alt="bostonImg1" onclick="changeImg('../img/boston (3).png');" />
          </li>
          <li>
            <img src="../img/TAMimg.png" alt="bostonImg1" onclick="changeImg('../img/TAMimg.png');"/>
          </li>
        </ul>
        <img src="../img/boston (1).png" alt="mainImg" id="mainImg" />
      </section>
      ...
      <form
        ...
        >
        <input type="hidden" name="productname" value="Camiseta NBA Boston Celtics">
        <input type="hidden" name="codProd" id="codProdValue">
        <h2>Camiseta NBA Boston Celtics</h2>
        <p id="codProd">Cod: LA001</p>
          <p>Escolha a <span>COR</span> :</p>
          <input type="color" id="color" name="branco" value="#ffffff" disabled/>
          <input type="radio" name="color" id="branco" value="branco"/>
