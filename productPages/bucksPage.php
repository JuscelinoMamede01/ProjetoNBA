    ...
    <main id="main">
      <section class="productImg">
        <ul class="prodImgList">
          <li>
            <img src="../img/bucks.png" alt="bucksImg" onclick="changeImg('../img/bucks.png');" />
          </li>
          <li>
            <img src="../img/bucks (1).png" alt="bucksImg" onclick="changeImg('../img/bucks (1).png');"/>
          </li>
          <li>
            <img src="../img/bucks (2).png" alt="bucksImg" onclick="changeImg('../img/bucks (2).png');"/>
          </li>
          <li>
            <img src="../img/TAMimg.png" alt="bucksImg" onclick="changeImg('../img/TAMimg.png');"/>
          </li>
        </ul>
        <img src="../img/bucks.png" alt="mainImg" id="mainImg" />
      </section>
      ...
      <form
        ...
        >
        <input type="hidden" name="productname" value="Camiseta NBA Milwaukee Bucks">
        <input type="hidden" name="codProd" id="codProdValue">
        <h2>Camiseta NBA Milwaukee Bucks</h2>
        <p id="codProd">Cod: LA004</p>
          <p>Escolha a <span>COR</span> :</p>
          <input type="color" id="color" name="Preto" value="#000000" disabled />
