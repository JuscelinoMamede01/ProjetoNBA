  ...
  <body id="body">
    ...
    <main id="main">
      ...
      <form
        ...
        >
        <input type="hidden" name="productname" value="Camiseta NBA USA Squad">
        <input type="hidden" name="codProd" id="codProdValue">
        <h2>Camiseta NBA USA Squad</h2>
        <p id="codProd">Cod: LA008</p>
          <p>Escolha a <span>COR</span> :</p>
          <input type="color" id="color" name="Azul" value="#000B47" disabled/>
